...
pub(super) enum Tag {
  ...
  Mint20StateTransitionFunction = 48,
  Mint20From = 50,
  Mint20Proof = 52,
  Mint20Body = 54,

  Mint21StateTransitionFunction = 56,
  Mint21From = 58,
  Mint21Proof = 60,
  Mint21Body = 62,

  Mint30StateTransitionFunction = 64,
  Mint30From = 66,
  Mint30Proof = 68,
  Mint30Body = 70,

  Mint31StateTransitionFunction = 72,
  Mint31From = 74,
  Mint31Proof = 76,
  Mint31Body = 78,

  Burn2StateTransitionFunction = 80,
  Burn2To = 82,
  Burn2Proof = 84,
  Burn2Body = 86,

  Burn3StateTransitionFunction = 88,
  Burn3To = 90,
  Burn3Proof = 92,
  Burn3Body = 94,
