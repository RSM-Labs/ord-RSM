...
pub(super) enum Tag {
  ...
  Mint20StateTransitionFunction = 44,
  Mint20From = 46,
  Mint20Proof = 48,
  Mint20Body = 50,

  Mint21StateTransitionFunction = 52,
  Mint21From = 54,
  Mint21Proof = 56,
  Mint21Body = 58,

  Mint30StateTransitionFunction = 60,
  Mint30From = 62,
  Mint30Proof = 64,
  Mint30Body = 66,

  Mint31StateTransitionFunction = 68,
  Mint31From = 70,
  Mint31Proof = 72,
  Mint31Body = 74,

  Burn2StateTransitionFunction = 76,
  Burn2To = 78,
  Burn2Proof = 80,
  Burn2Body = 82,

  Burn3StateTransitionFunction = 84,
  Burn3To = 86,
  Burn3Proof = 88,
  Burn3Body = 90,
