...
pub(super) enum Tag {
  ...
  Contract = 24,
  Burn3AbleRuneId0Block = 26,
  Burn3AbleRuneId0Tx = 28,
  Burn3AbleRuneId1Block = 30,
  Burn3AbleRuneId1Tx = 32,

  LpFeePercentage = 34,
  ServiceFeePercentage = 36,
  ParentBlock = 38,
  ParentTx = 40,
  ...
  Mint20StateTransitionFunction = 50,
  Mint20From = 52,
  Mint20Proof = 54,
  Mint20Body = 56,

  Mint21StateTransitionFunction = 58,
  Mint21From = 60,
  Mint21Proof = 62,
  Mint21Body = 64,

  Mint30StateTransitionFunction = 66,
  Mint30From = 68,
  Mint30Proof = 70,
  Mint30Body = 72,

  Mint31StateTransitionFunction = 74,
  Mint31From = 76,
  Mint31Proof = 78,
  Mint31Body = 80,
